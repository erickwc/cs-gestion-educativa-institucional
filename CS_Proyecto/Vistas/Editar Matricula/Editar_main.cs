...
{
    public partial class Editar_main : Form
    {
        public Editar_main()
        {
            InitializeComponent();
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Datos_personales));
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Residencia_contacto));
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Situacion_familiar));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Datos_complementarios));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Responsable_principal));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
            SeccionInactiva(btn_situacion_familiar);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Responsable_secundario));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
            SeccionInactiva(btn_situacion_familiar);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Editar_Matricula.Editar_Medicamentos));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
            SeccionInactiva(btn_situacion_familiar);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Pago_matricula));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
            SeccionInactiva(btn_situacion_familiar);
        ...
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Identificacion));
            SeccionInactiva(btn_residencia_contacto);
            SeccionInactiva(btn_datos_personales);
            SeccionInactiva(btn_datos_complemetarios);
            SeccionInactiva(btn_situacion_familiar);
        ...
        private void Editar_main_Load(object sender, EventArgs e)
        {
            navegar.AbrirFormEnPanelModificarMatricula(typeof(Vistas.Formulario_Matricula.Datos_personales));
            SeccionActiva(btn_datos_personales);
        }
        ...
        private void btn_modificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(Atributos_Alumno.NIE) && string.IsNullOrWhiteSpace(Atributos_Alumno.NieTemporal))
                {
                ...
                Atributos_Alumno.NumeroDeTalonario
                   ...
                   // limpiarvar.LimpiarVariablesMatriculaAlumno();
                    ClasesVista.OscurecerFondo fondo = new ClasesVista.OscurecerFondo();
                    using (Vistas.Mensajes_Funcionales.AlumnoModificado registro_exitoso = new Vistas.Mensajes_Funcionales.AlumnoModificado())
                    {
        ...
        private void ActivarSecciones_Tick(object sender, EventArgs e)
        {
