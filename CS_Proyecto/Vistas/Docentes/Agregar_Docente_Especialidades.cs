...
{
    public partial class Agregar_Docente_Especialidades : Form
    {
        public Agregar_Docente_Especialidades()
        {
            InitializeComponent();
        }
        ...
        private void mostrarMateriasRegistro()
        {
            ...
            dvg_cargos.DataSource = empleado.MostrarEspecialidadesParaCompletarRegistro();

            //Inmovilizar columnas 
            DataTable tabla = new DataTable();
            dvg_cargos.Columns["IdEspecialidadDocentes"].SortMode = DataGridViewColumnSortMode.NotSortable;
            dvg_cargos.Columns["Especialidades"].SortMode = DataGridViewColumnSortMode.NotSortable;

            //Poner Invisible una columna
            dvg_cargos.Columns["IdEspecialidadDocentes"].Visible = false;
        ...
        {
            CD_Empleados empleado = new CD_Empleados();
            dvg_cargos_docente.DataSource = empleado.MostrarEspecialidadesAgregadosDocentes(Atributos_Empleado.IdDocente);

            //Inmovilizar columnas 
            DataTable tabla = new DataTable();
            dvg_cargos_docente.Columns["IdDocenteEspecialidades"].SortMode = DataGridViewColumnSortMode.NotSortable;
            dvg_cargos_docente.Columns["Especialidades"].SortMode = DataGridViewColumnSortMode.NotSortable;

            //Poner Invisible una columna
            dvg_cargos_docente.Columns["IdDocenteEspecialidades"].Visible = false;
        ...
        private void dvg_cargos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dvg_cargos.Columns["ImagenColumna"].Index && e.RowIndex >= 0)
            {
                ...
                IdMateria = dr.Cells["IdEspecialidadDocentes"].Value.ToString();
                MateriaNueva = dr.Cells["Especialidades"].Value.ToString();

                foreach (DataGridViewRow dr1 in dvg_cargos_docente.Rows)
                {
                    MateriaAgregada = dr1.Cells["Especialidades"].Value.ToString();
                ...
                {
                    CD_Empleados empleado = new CD_Empleados();
                    empleado.AgregarEspecialidadesDocentes(Convert.ToInt32(IdMateria), Atributos_Empleado.IdDocente);
        ...
        private void dvg_cargos_docente_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dvg_cargos_docente.Columns["ImagenColumna"].Index && e.RowIndex >= 0)
            {
                ...
                IdDocenteMaterias = dr.Cells["IdDocenteEspecialidades"].Value.ToString();
                MateriaNueva = dr.Cells["Especialidades"].Value.ToString();

                bool materiaDuplicada = false;
                int rowIndexInDgvMaterias = -1; 
                ...
                foreach (DataGridViewRow dr1 in dvg_cargos.Rows)
                {
                    ...
                    {
                        materiaDuplicada = true;
                        rowIndexInDgvMaterias = dr1.Index; 
                        break;
                    }
                }
                ...
                {
                    CD_Empleados empleado = new CD_Empleados();
                    empleado.EliminarEspecialidadesDocentes(Convert.ToInt32(IdDocenteMaterias));
                    mostrarMateriasAgregadas();
        ...
        private void Agregar_Docente_Especialidades_Load(object sender, EventArgs e)
        {
        ...
        private void Agregar_Docente_Especialidades_Shown(object sender, EventArgs e)
        {
            foreach (DataGridViewRow dr in dvg_cargos.Rows)
            {
                string MateriaNueva = dr.Cells["Especialidades"].Value.ToString();

                foreach (DataGridViewRow dr1 in dvg_cargos_docente.Rows)
                {
                    string MateriaAgregada = dr1.Cells["Especialidades"].Value.ToString();
